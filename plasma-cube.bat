...
for /L %%1 in (1,1,300) do if not defined STOP (
	...
	start /B /HIGH cmdgfx_gdi "block 0 0,0,70,50 110,0 -1 0 0 %STREAM% sin((x+!COLCNT!/1)/110)*13*sin((y+!COLCNT2!/5)/65)*8 & 3d objects\!FNAME! !DRAWMODE!,-1 !RX!,!RY!,!RZ! 0,0,0 !MOD!,0,0,10 %XMID%,%YMID%,!DIST!,%ASPECT% !PAL!" Z300f1:0,0,181,%H%
	
	cmdgfx_gdi "" f0:0,0,0,0W10k
