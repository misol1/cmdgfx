...
cmdgfx_input.exe knW13xR | call %0 %* | cmdgfx_RGB "" Sf0:0,0,660,110,220,110sE
set __=
cls
...
if "%~1"=="BKGWIN" cmdgfx_RGB "image img/6hld.bmp 0 0 db -1 0,0 0 0 !W!,!H!" f0:0,0,!W!,!H!K & goto :eof
...
for /L %%_ in (1,1,300) do if not defined STOP (
	...
	echo "cmdgfx: !OUTP:~1,-1! & skip image img/6hld.bmp 0 0 db -1 !WW!,0 0 0 !W!,!H! & skip block 0,100 !WW!,0,!W!,!H! 0,0 -1 & !MONS! & !FADE! & skip text 7 0 0 [FRAMECOUNT] 103,108 & !MSG!" f0:0,0,!WWW!,!H!,!W!,!H!
	set OUTP=
