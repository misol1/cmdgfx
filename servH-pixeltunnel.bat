...
set /A CRX=0,CRY=0,CRZ=0, ZROT=0
set ASPECT=0.75

call sindef.bat

:: decrease NOF if scripts runs slow
set /a NOF=23

set WNAME=objects\tunnel-circle.ply
if exist %WNAME% goto SKIPGEN

:: try higher values for OW, like 16, 32, 60 ! (must remove SKIPGEN jump below in that case)
set /a OW=8
set /a CNT=360/%OW%
set /a CNTV=%CNT%+1
...
:SKIPGEN
set /A ADD1=4, ADD2=2, BDIST=1200
...
set /a SHOWHELP=1
set HELPMSG=text 7 0 0 SPACE\-\g1e\g1f\-z\-x/X\-y/Y\-p\-h 1,78
...
for /L %%1 in (1,1,300) do if not defined STOP (
	...
	echo "cmdgfx: fbox !BGC! 20 0,0,%W%,%H% & !CRSTR:~1,-1! & !MSG!"
	set CRSTR=
