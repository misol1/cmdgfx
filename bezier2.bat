...
::set /a P1=6,P2=0,P3=1,P4=1,P5=6,P6=6,P7=0,P8=0,SC=128,CC=493,SC2=679,CC2=441,SC3=393,CC3=547,SC4=330,CC4=115
::set /a P1=0,P2=4,P3=5,P4=1,P5=1,P6=0,P7=1,P8=3,SC=494,CC=717,SC2=375,CC2=430,SC3=103,CC3=177,SC4=85,CC4=130
::set /a P1=5,P2=1,P3=0,P4=5,P5=6,P6=1,P7=2,P8=2,SC=164,CC=48,SC2=171,CC2=71,SC3=92,CC3=78,SC4=518,CC4=356
::set /a P1=4,P2=0,P3=0,P4=0,P5=2,P6=6,P7=5,P8=5,SC=114,CC=142,SC2=171,CC2=541,SC3=36,CC3=472,SC4=596,CC4=434
::set /a P1=3,P2=3,P3=4,P4=1,P5=0,P6=0,P7=3,P8=6,SC=343,CC=168,SC2=577,CC2=703,SC3=234,CC3=98,SC4=338,CC4=371
::set /a P1=3,P2=0,P3=1,P4=6,P5=6,P6=4,P7=1,P8=2,SC=207,CC=226,SC2=313,CC2=58,SC3=620,CC3=295,SC4=289,CC4=161
