...
cmdwiz fullscreen 0
cmdwiz setfont 6 & mode %F6W%,%F6H% & cls & title Z buffer test 2
cmdwiz showcursor 0
if defined __ goto :START
set __=.
cmdgfx_input.exe m0nuW10xR | call %0 %* | cmdgfx_gdi "" eSf0:0,0,%W%,%H%Bs
set __=
...
set /a DIST=2500, DRAWMODE=1, ROTMODE=0, SHOWHELP=1, HLPY=H-2
set ASPECT=0.7083
...
set YPAL=f e b2  f e b2  f e b1  f e b0  e 0 db  e c b2  e c b1  c 0 db  c 4 b1  c 4 b2  4 0 db  4 0 b1 4 0 b0 4 0 db  4 0 b2  4 0 b1  0 0 db  0 0 db
...
for /L %%1 in (1,1,400) do if not defined STOP for %%o in (!DRAWMODE!) do (
	echo "cmdgfx: fbox 8 0 . 0,0,!W!,!H! & !MSG:~1,-1! & 3d objects\!FNAME! !DRAWMODE!,!O%%o! !RX!,!RY!,!RZ! 0,0,0 !MOD!,-4000,0,10 !XMID!,!YMID!,!DIST!,%ASPECT% !PAL! & 3d objects\springy1.plg !DRAWMODE!,!O%%o! !RY!,!RZ!,!RX! 0,0,0 -0.23,-0.23,-0.23, 0,0,0 0,-4000,0,10 !XMID!,!YMID!,!DIST!,%ASPECT% %YPAL%" Ff0:0,0,!W!,!H!
	...
	if !ROTMODE! == 0 set /a RX+=2, RY+=4, RZ-=3, XMID=!W!/2, YMID=!H!/2
	
	if !K_EVENT! == 1 (
		if !K_DOWN! == 1 (
			for %%a in (331 333 328 336 122 90 100 68 329 337 327 335) do if !KEY! == %%a set /a ACTIVE_KEY=!KEY!
			if !KEY! == 10 cmdwiz getfullscreen & set /a ISFS=!errorlevel! & (if !ISFS!==0 cmdwiz fullscreen 1) & (if !ISFS! gtr 0 cmdwiz fullscreen 0)
			if !KEY! == 32 set /A DRAWMODE+=1&(if !DRAWMODE! gtr 2 set DRAWMODE=0)&for %%a in (!DRAWMODE!) do set PAL=!PAL%%a!
