...
set __=.
cmdgfx_input.exe knW16x | call %0 %* | cmdgfx "" Sf1:0,0,%W%,%H%
set __=
set W=&set H=
...
for /L %%1 in (1,1,300) do if not defined STOP (	
	...
	if !MODE!==0 echo "cmdgfx: block 0 0,0,%W%,!HM! 0,0 -1 0 0 - store(gtr(col(x-1,y-1),0)+gtr(col(x,y-1),0)+gtr(col(x+1,y-1),0)+gtr(col(x-1,y),0)+gtr(col(x+1,y),0)+gtr(col(x-1,y+1),0)+gtr(col(x,y+1),0)+gtr(col(x+1,y+1),0),0)+((1-(lss(s0,2)+gtr(s0,3)))*gtr(col(x,y),0)+eq(col(x,y)*10+s0,3))*!COL! !HELP:~1,-1! & skip %EXTRA%%EXTRA%%EXTRA%%EXTRA%%EXTRA%"

	rem with color shifts
	if !MODE! == 1 echo "cmdgfx: block 0 0,0,%W%,!HM! 0,0 -1 0 0 - store(col(x,y)+1,1)+store(gtr(col(x-1,y-1),0)+gtr(col(x,y-1),0)+gtr(col(x+1,y-1),0)+gtr(col(x-1,y),0)+gtr(col(x+1,y),0)+gtr(col(x-1,y+1),0)+gtr(col(x,y+1),0)+gtr(col(x+1,y+1),0),0)+((1-(lss(s0,2)+gtr(s0,3)))*gtr(col(x,y),0)+eq(col(x,y)*10+s0,3))*s1 !HELP:~1,-1! & skip %EXTRA%%EXTRA%%EXTRA%%EXTRA%%EXTRA%"
