...
set __=.
call %0 %* | cmdgfx_gdi "" kOW12z%TOP%TSf0:0,0,%W%,%H% 331111,661122,664444,991122,DD1133,AA5522,CC6633,CC2244,AA6655,DD6655,CC8855,DD9966,DD7788,EEBB99,FFEEDD
set __=
cls
...
for /L %%1 in (1,1,300) do if not defined STOP (
	...
	echo "cmdgfx: 3d objects\plane-pepper.obj 0,-1 !RX!,!RY!,!RZ! 0,0,0 %SCALE%,%SCALE%,%SCALE%,0,0,0 0,0,0,0 %XMID%,%YMID%,!DIST!,%ASPECT% 0 0 0 & !SKIP! 3d objects\spaceship.obj 1,0 700,!RZ!,!RX! 0,0,0 100,100,100,0,0,0 0,0,0,0 %XMID%,%YMID%,1000,%ASPECT% 0 0 0 & text 9 0 0 SPACE 0,0 & skip %EXTRA%%EXTRA%%EXTRA%%EXTRA%%EXTRA%"
