...
mode 320,110
set __=.
cmdgfx_input.exe M10unW25x | call %0 %* | cmdgfx_gdi "" Sfa:0,0,1280,680Z800
set __=
mode 80,50
...
for /L %%1 in (1,1,300) do if not defined STOP (
	...
	echo "cmdgfx: !BKSTR:~1,-1! & 3d %FN2% !DRAWMODE!,-1 !RX!,!RY!,!RZ! 0,0,0 1,1,1,!TX!,!TY!,!TZ! 1,-200,0,300 %XMID%,!YMID!,%DIST%,!ASPECT! %GROUNDCOLS% & 3d !FN3! !DRAWMODE!,-1 !RX!,!RY!,!RZ! 0,0,0 1,1,1,!TX!,!TY!,!TZ! 1,-200,0,300 %XMID%,!YMID!,%DIST%,%ASPECT% !CUBECOLS! & !MAPT! & !MAPP! & skip %EXTRA%%EXTRA%%EXTRA%%EXTRA%%EXTRA%" FDfa:0,0,1280,680Z800
