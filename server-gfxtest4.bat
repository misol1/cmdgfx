...
cmdwiz fullscreen 0
cmdwiz setfont 6 & mode %F6W%,%F6H% & cls & title 3d test
cmdwiz showcursor 0
if defined __ goto :START
set __=.
cmdgfx_input.exe m0nuW10xR | call %0 %* | cmdgfx_gdi "" eSf0:0,0,%W%,%H%
set __=
...
if %OBJINDEX% == 20 set FNAME=mengersponge.obj& set MOD=0.5,0.5,0.5, 0,-500,0 1
if %OBJINDEX% == 21 set FNAME=al.obj& set MOD=150,150,150, 0,0,0 0
