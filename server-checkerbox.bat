...
cmdwiz setfont 6 & mode %F6W%,%F6H% & cls & title Checkerbox
cmdwiz showcursor 0
if defined __ goto :START
set __=.
cmdgfx_input.exe m0nuW10x | call %0 %* | cmdgfx_gdi "" Sf0:0,0,200,110
set __=
cls
...
for /L %%1 in (1,1,300) do if not defined STOP (
	echo "cmdgfx: fbox 0 0 00 0,0,%W%,%H% & 3d objects\checkerbox\plane!OBJINDEX!.obj 0,58 0,0,!RZ2! 0,0,0 45,45,45,0,0,0 0,0,0,10 %XMID%,%YMID%,700,%ASPECT% 0 !PLANEMOD! db & 3d objects\checkerbox\box!OBJINDEX!.obj !DRAWMODE!,!TRANSP! !RX!,!RY!,!RZ! 0,0,0 400,400,400,0,0,0 !CULL!,0,0,10 %XMID%,%YMID%,!DIST!,%ASPECT% !COL! & %TEXT%" Fe!DELOBJCACHE!Z%ZP%f%FONT%:0,0,%W%,%H%
	rem echo "cmdgfx: fbox 0 0 00 0,0,%W%,%H% & 3d %PLANETEMP% 0,58 0,0,!RZ2! 0,0,0 45,45,45,0,0,0 0,0,0,10 %XMID%,%YMID%,700,%ASPECT% 0 !PLANEMOD! db & 3d %OBJTEMP% !DRAWMODE!,!TRANSP! !RX!,!RY!,!RZ! 0,0,0 400,400,400,0,0,0 !CULL!,0,0,10 %XMID%,%YMID%,!DIST!,%ASPECT% !COL! & %TEXT%" Fe!DELOBJCACHE!Z%ZP%f%FONT%:0,0,%W%,%H%
