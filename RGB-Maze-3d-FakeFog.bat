...
cmdwiz getdisplaydim w & set /a SW=!errorlevel!
cmdwiz getdisplaydim h & set /a SH=!errorlevel!
...
for /l %%1 in (1,1,300) do if not defined STOP (
	...
	set LAYERS=""& set /a FAR=25000 & set COLMOD=40000000
	for %%a in (10000 5000 3000 -500) do set LAYERS="!LAYERS:~1,-1! & 3d %FN2% !DRAWMODE!,-1 !RX!,!RY!,!RZ! 0,0,0 1,1,1,!TX!,!TY!,!TZ! 1,%%a,!FAR!,30 !XMID!,!YMID!,%DIST%,!ASPECT! %GROUNDCOLS% & 3d %FN% !DRAWMODE!,-1 !RX!,!RY!,!RZ! 0,0,0 1,1,1,!TX!,!TY!,!TZ! 1,%%a,!FAR!,30 !XMID!,!YMID!,%DIST%,%ASPECT% !CUBECOLS!"&set /a FAR=%%a & if %%a gtr 0 set LAYERS="!LAYERS:~1,-1! & ipoly !COLMOD! 0 0 20 0,0,!W!,0,!W!,!H!,0,!H!"
	
	echo "cmdgfx: !BKSTR:~1,-1! & !LAYERS:~1,-1! & !MAPT! & !MAPP! & skip text f 0 0 [FRAMECOUNT] 10,10 6" Ffa:0,0,!W!,!H!Z!ZVAL!
	set LAYERS=
