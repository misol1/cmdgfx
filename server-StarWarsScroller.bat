...
set __=.
cmdgfx_input.exe m0unW10x | call %0 %* | cmdgfx_gdi "" TSfa:0,0,700,480Z300 000000,202000,505000,c0c000
set __=
cls
...
set /a TEY_OFFSET=-35500, TEY_DELTA=30, TXSCALE=100000
set ASPECT=0.675
...
for /L %%1 in (1,1,300) do if not defined STOP (
   ...
   echo "cmdgfx: fbox 0 0 fa 0,0,%W%,%H% & 3d objects\starfield200_0.ply 1,1 0,0,0 0,0,0 10,15,10,0,0,0 0,0,0,10 %XMID%,232,200,%ASPECT% %SCOLS% & 3d objects/plane-StarWars.obj 5,0,0,!TEY_OFFSET!,!TXSCALE!,40000 !RX!,!RY!,!RZ! 0,0,0 30,50,1,0,0,0 0,0,0,10 !XMID!,!YMID!,!DIST!,%ASPECT% 0 0 db & !FADE:~1,-1!" !XTRAFLAG!F
	set XTRAFLAG=
