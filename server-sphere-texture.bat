...
set __=.
cmdgfx_input.exe m0nuW10x | call %0 %* | cmdgfx_gdi "" Sf0:0,0,200,90Z300T
set __=
cls
...
set HELPMSG=text 3 0 0 mM\-c\-t\-SPACE\-D/d\-r\-s\-Zz\-h\-ENTER\-\g1e\g1f 2,88
set MSG=%HELPMSG%

set /a ACTIVE_KEY=0, OS=23
set /a TEX_OFFSET=-3000, A1=0, A2=0, YDELT=2, XP=%XMID%, YP=%YMID%, XDELT=1, YSCALE=!OS!, SCALE=0, AUTOROT=1
...
for /L %%1 in (1,1,300) do if not defined STOP (
	...
	set /a TC=!TRANSP!-1
   echo "cmdgfx: fbox 8 0 20 0,0,%W%,%H% & !CHECKSKIP! 3d objects\checkerbox\plane0.obj 0,58 0,0,!A1! 0,0,0 45,35,45,0,0,0 0,0,0,10 %XMID%,%YMID%,700,%ASPECT% 0 -8 db & !BACKSKIP! 3d objects/sphere-tex.obj !DRAWMODE!,!TC!,!TEX_OFFSET!,0,10000,!TYSCALE! !RX!,!RY!,!RZ! 0,0,0 -!OS!,-!YSCALE!,-!OS!,0,-132,0 1,0,0,10 !XP!,!YP!,!DIST!,%ASPECT% 0 0 . & 3d objects/sphere-tex.obj !DRAWMODE!,!TC!,!TEX_OFFSET!,0,10000,!TYSCALE! !RX!,!RY!,!RZ! 0,0,0 !OS!,!YSCALE!,!OS!,0,-132,0 1,0,0,10 !XP!,!YP!,!DIST!,%ASPECT% 0 0 db & block 0 0,0,%W%,%H% 0,0 -1 1 & !MSG!" F!XTRAFLAG!
	set XTRAFLAG=
	
   rem echo "cmdgfx: fbox 8 0 fa 0,0,%W%,%H% & 3d objects/cube-tex.obj !DRAWMODE!,-1,!TEX_OFFSET!,0,3000 !RX!,!RY!,!RZ! 0,0,0 3500,3500,3500,0,0,0 1,0,0,10 %XMID%,%YMID%,!DIST!,%ASPECT% 0 0 db & block 0 0,0,%W%,%H% 0,0 -1 1 & !MSG!" F
	...
	if !XP! gtr 170 set /a XDELT=-XDELT
	...
	if !ACTIVE_KEY! gtr 0 (
		...
		if !ACTIVE_KEY! == 100 set /a ORGDIST+=200
		if !ACTIVE_KEY! == 68 set /a ORGDIST-=200
   )
	set /a KEY=0
)
