...
set __=.
cmdgfx_input.exe knW14xR | call %0 %* | cmdgfx_gdi "" Sf0:0,0,200,102t4
set __=
cls
...
set /a MODE=0, XMUL=300, YMUL=280, A1=155, A2=0, RANDPIX=3, COLCNT3=0, FADEIN=0, FADEVAL=0, WH=W/2, HLPY=H-2
set HELP=text 7 0 0 SPACE,_UP/DOWN,_ENTER,_P,_H 1,%HLPY%
...
for /L %%1 in (1,1,300) do if not defined STOP (
	...
	if "!RESIZED!"=="1" set /a "W=SCRW*2*rW/100+1, H=SCRH*2*rH/100+1, WH=W/2, HLPY=H-3, XMUL=300+(W-200)*1, YMUL=280+(W-200)/2" & cmdwiz showcursor 0 & set HELPMSG=text 7 0 0 SPACE,_UP/DOWN,_ENTER,_P,_H 1,!HLPY!&if not "!HELP!"=="" set HELP=!HELPMSG!
