...
cmdwiz setfont 2 & mode 120,90 & cls
cmdwiz showcursor 0
...
for /L %%1 in (1,1,300) do if not defined STOP (
	...
	if "!RESIZED!"=="1" set /a "W=SCRW*rW/100+1, BW=W+240, IX=W+200, H=SCRH*rH/100+5" & cmdwiz showcursor 0
	
	if !K_DOWN! == 1 (
		if !KEY! == 331 (if !NOF_SHIPS! gtr 1 set /a NOF_SHIPS-=1) & call :SET_TITLE !NOF_SHIPS! 
		if !KEY! == 333 set /a NOF_SHIPS+=1 & call :INIT_SHIP !NOF_SHIPS! & call :SET_TITLE !NOF_SHIPS!
...
:SET_TITLE
title Block scaling and rotation (cursor left/right) - Ships: %1
