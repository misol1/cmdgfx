		...
		while (stop == 0) {
			...
			if (death==1) {
				...
				for (k = 1; k <= 40; k++) {
					...
					TILT+=40
					WScript.Echo("\"cmdgfx: 3d tetramod.ply " + DRAWMODE + ",-1 0,180," + TILT + " 0,-1800,4000 -50,-50,-50,0,0,0 1,0,0,10 " + XMID + "," + YMID + "," + DIST + "," + ASPECT + " f " + GROUNDCOL + " " + PLYCHAR + " 7 " + GROUNDCOL + " " + PLYCHAR + " & text 7 1 0 SCORE:_" + SCORE + "_(" + HISCORE + ") 2,1  \" -s")
					var input = WScript.StdIn.ReadLine()
				}
			}
