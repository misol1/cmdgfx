...
set __=.
cmdgfx_input.exe knW12x | call %0 %* | cmdgfx_gdi.exe "" eSf0:0,0,220,110
set __=
cls
...
echo "cmdgfx: image background.gxy 2 0 0 -1 0,0 & %CUBES:~1,-1% & text e 0 0 Score:_!SCORE!_\e0(!HISCORE!) 2,1" Dec:0,0,%W%,%H%,1,1
