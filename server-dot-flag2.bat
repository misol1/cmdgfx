@echo off
bg font 1 & mode 180,80 & cls
cmdwiz showcursor 0
if defined __ goto :START
set __=.
call %0 %* | cmdgfx_gdi "" kOSf1:0,0,330,80,180,80W12
set __=
cls
...
for /L %%1 in (1,1,300) do if not defined STOP (
  ...
  echo "cmdgfx: fbox 1 0 db 180,0,180,80 & fbox 1 0 b1 0,0,180,80 & image capture-!MODE!.gxy 0 0 0 -1 180,0 & block 0 0,0,330,80 0,0 -1 0 0 ? ? 17+x-180+sin(!XC!/100+floor((x-180)/!BXA!)*0.!D1!+floor(y/!BYA!)*0.!D2!)*!XMUL!+eq(fgcol(x,y),1)*500  !YMOD!+y+cos(!YC!/100+floor((x-180)/!BXA!)*0.!D3!+floor(y/!BYA!)*0.!D4!)*!YMUL! to 180,0,150,80 & !TEXT! & skip %EXTRA%%EXTRA%%EXTRA%%EXTRA%%EXTRA%"
