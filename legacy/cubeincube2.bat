...
for /L %%1 in (1,1,300) do if not defined STOP for %%c in (!COLCNT!) do (
	start "" /B /High cmdgfx_gdi "fbox 0 0 db 0,0,480,%H% & 3d objects\cube.ply 4,0 !CRX1!,!CRY1!,!CRZ1! 0,0,0 -60,-60,-60,0,0,0 1,0,0,10 %XMID%,%YMID%,!DIST!,%ASPECT% %COLS1% & 3d objects\cube.ply 4,0 !CRX2!,!CRY2!,!CRZ2! 0,0,0 -160,-160,-160,0,0,0 1,0,0,10 %OFFXMID%,%YMID%,!DIST!,%ASPECT% %COLS2% & block 0 0,0,480,80 0,0 -1 0 0 - xor(col(x,y),col(x+320,y)) & fbox 0 0 db 160,0,320,%H% & & 3d objects\cube.ply 4,0 !CRX3!,!CRY3!,!CRZ3! 0,0,0 -270,-270,-270,0,0,0 1,0,0,10 %OFFXMID%,%YMID%,!DIST!,%ASPECT% %COLS3% & block 0 0,0,480,80 0,0 -1 0 0 - xor(col(x,y),col(x+320,y)) & fbox 0 0 db 160,0,320,%H% & 3d objects\cube.ply 4,0 !CRX4!,!CRY4!,!CRZ4! 0,0,0 -480,-480,-480,0,0,0 1,0,0,10 %OFFXMID%,%YMID%,!DIST!,%ASPECT% %COLS4% & block 0 0,0,480,80 0,0 -1 0 0 - xor(col(x,y),col(x+320,y)) & fbox 0 0 db 160,0,320,%H% & 3d objects\cube.ply 4,0 !CRX5!,!CRY5!,!CRZ5! 0,0,0 -790,-790,-790,0,0,0 1,0,0,10 %OFFXMID%,%YMID%,!DIST!,%ASPECT% %COLS5% & block 0 0,0,480,80 0,0 -1 0 0 - xor(col(x,y),col(x+320,y)) " f1:0,0,480,80,160,80 !COL%%c!

rem		start "" /B /High cmdgfx_gdi "fbox 0 0 db 0,0,480,%H% & 3d objects\cube.ply 4,0 !CRX1!,!CRY1!,!CRZ1! 0,0,0 -60,-60,-60,0,0,0 1,0,0,10 %XMID%,%YMID%,!DIST!,%ASPECT% %COLS1% & 3d objects\cube.ply 4,0 !CRX2!,!CRY2!,!CRZ2! 0,0,0 -160,-160,-160,0,0,0 1,0,0,10 %OFFXMID%,%YMID%,!DIST!,%ASPECT% %COLS2% & block 0 0,0,480,80 0,0 -1 0 0 - xor(col(x,y),col(x+320,y)) & fbox 0 0 db 160,0,320,%H% & & 3d objects\cube.ply 4,0 !CRX3!,!CRY3!,!CRZ3! 0,0,0 -270,-270,-270,0,0,0 1,0,0,10 %OFFXMID%,%YMID%,!DIST!,%ASPECT% %COLS3% & block 0 0,0,480,80 0,0 -1 0 0 - xor(col(x,y),col(x+320,y)) & fbox 0 0 db 160,0,320,%H% & 3d objects\cube.ply 4,0 !CRX4!,!CRY4!,!CRZ4! 0,0,0 -480,-480,-480,0,0,0 1,0,0,10 %OFFXMID%,%YMID%,!DIST!,%ASPECT% %COLS4% & block 0 0,0,480,80 0,0 -1 0 0 - xor(col(x,y),col(x+320,y)) & fbox 0 0 db 160,0,320,%H% & 3d objects\cube.ply 4,0 !CRX5!,!CRY5!,!CRZ5! 0,0,0 -790,-790,-790,0,0,0 1,0,0,10 %OFFXMID%,%YMID%,!DIST!,%ASPECT% %COLS5% & block 0 0,0,480,80 0,0 -1 0 0 - xor(col(x,y),col(x+320,y)) " fc:0,0,480,80 !COL%%c!
