...
set /a REPATT=15
set I1_0=img/dos_shade.pcx 0 0 db -1&set I2_0=img/mario1.gxy 0 0 0 -1&set I3_0=legacy\gfxtest3.bat e 0 0 -1
set I1_1=img/dos_shade.pcx 0 0 db 0&set I2_1=img/mario1.gxy 0 0 0 0&set I3_1=legacy\gfxtest3.bat e 0 0 10
set /a IMG=1, TR=0
