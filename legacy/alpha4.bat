...
for /L %%1 in (1,1,300) do if not defined STOP (
	...
	start "" /B /High cmdgfx_gdi "fbox !BGCOL! 0 b0 0,0,%W%,%H% & skip image img\spiral.txt 1 0 0 -1 0,0 0 0 %W%,%H%&!OUTP:~1,-1!" Z300f1
	set OUTP=
	cmdgfx.exe "" knW12
	set KEY=!ERRORLEVEL!
	...
	if !EXIT! == 1 (
		if !ROTMODE! == 0 set /a "CRX+=11,CRY+=11,CRZ+=11" & (if !CRX! gtr 1420 set /a CRX=1440)&(if !CRY! gtr 1420 set /a CRY=1440)&(if !CRZ! gtr 1420 set /a CRZ=1440)
