...
for /L %%1 in (1,1,300) do if not defined STOP (
	...
	if !a! geq 1 (
		...
		if !DIV! == 2 start /B /HIGH cmdgfx_gdi "fbox !COL! 0 00 0,0,%W%,%H% & !STR:~1,-1! & block 0 0,0,%SXMID%,%SYMID% %SXMID%,0 -1 1 0 - - & block 0 0,0,%SXMID%,%SYMID% 0,%SYMID% -1 0 1 & block 0 0,0,%SXMID%,%SYMID% %SXMID%,%SYMID% -1 1 1" kOf0:0,0,!W!,!H!
