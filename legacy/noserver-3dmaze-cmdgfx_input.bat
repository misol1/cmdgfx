...
mode %F6W%,%F6H%
set __=.
cmdgfx_input.exe M0unW13xR | call %0 %*
set __=
mode 80,50
...
rem start /B cmdgfx_gdi.exe "text 8 0 0 Generating_world... 82,36" f0:0,0,180,80
...
set FN=objects\3dworld-maze.obj
set FN2=objects\3dworld-ground-maze.obj
...
for /l %%1 in (1,1,300) do if not defined STOP (
	...
	start /B /HIGH cmdgfx_gdi.exe "!BKSTR:~1,-1! & 3d %FN2% !DRAWMODE!,-1 !RX!,!RY!,!RZ! 0,0,0 1,1,1,!TX!,!TY!,!TZ! 1,-500,25000,300 !XMID!,!YMID!,%DIST%,!ASPECT! %GROUNDCOLS% & 3d %FN% !DRAWMODE!,-1 !RX!,!RY!,!RZ! 0,0,0 1,1,1,!TX!,!TY!,!TZ! 1,-100,25000,100 !XMID!,!YMID!,%DIST%,%ASPECT% !CUBECOLS! & !MAPT! & !MAPP!" fa:0,0,!W!,!H!Z!ZVAL!
	...
	if not !KEY! == 0 (
		...
		if !KEY! == 97 set ORY=!RY!&set /a RY+=360&(if !RY! gtr 1440 set /a RY=!RY!-1440)&(if !RY! lss 0 set /a RY=1440+!RY!)&call :MOVE 1 4&set RY=!ORY!
		if !KEY! == 100 set ORY=!RY!&set /a RY+=360&(if !RY! gtr 1440 set /a RY=!RY!-1440)&(if !RY! lss 0 set /a RY=1440+!RY!)&call :MOVE -1 4&set RY=!ORY!
