...
for %%a in (3dworld.dat 3dworld2.dat cmdgfx.exe cmdgfx_gdi.exe cmdwiz.exe 3dworld-ground-maze.obj 3dworld-maze.dat 3dworld-maze.obj 3dGUI.dat 3dGUI2.dat) do copy /Y %%a export
