...
for %%a in (3dworld.dat 3dworld2.dat cmdgfx.exe cmdgfx_gdi.exe cmdwiz.exe 3dworld-maze.dat 3dGUI.dat 3dGUI2.dat 3dGUI-RGB.dat cmdgfx_input.exe cmdgfx_RGB.exe pixelfnt.exe cmdgfx_VT.exe cmdgfx_RGB_32.exe) do copy /Y %%a export
