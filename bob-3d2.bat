...
for /L %%1 in (1,1,300) do if not defined STOP (
  ...
  if !MODE!==0 start /B /HIGH cmdgfx_gdi "fbox 1 0 b2 0,0,120,80 & fbox 1 0 08 120,0,120,80 & 3d objects\ball-object.obj 0,0 !RX!,!RY!,!RZ! 0,0,0 0.9,0.9,0.9,0,0,0 0,0,0,50 %XMID2%,%YMID%,!DIST!,2.0 0 0 0 & block 0 120,0,120,80 0,0 08 & block 0 0,0,120,70 0,50 0 0 0 ? ? x+0 (70-y)/2 & block 0 120,0,120,80 0,0 08 " f1:0,0,240,80
  
  if !MODE!==1 start /B /HIGH cmdgfx_gdi "fbox 1 0 b2 0,0,120,80 & fbox 1 0 08 120,0,120,80 & 3d objects\ball-object.obj 0,0 !RX!,!RY!,!RZ! 0,0,0 0.9,0.9,0.9,0,0,0 0,0,0,50 %XMID2%,%YMID%,!DIST!,2.0 0 0 0 & block 0 120,0,120,80 0,0 08 & fellipse f 1 b1 !MOONX!,13,10,7 & fellipse f 7 db !MOONX!,13,9,6 & fellipse f 1 b1 !MOONX!,53,9,3 & fellipse f 0 db !MOONX!,53,8,2 & fellipse f 1 b1 !MOONX!,60,6,2 & fellipse f 0 db !MOONX!,60,5,2 & block 0 0,0,120,70 0,50 0 0 0 10b2=10b0,10b1=10b0,?c??=?4??,?a??=?2??,?f??=?7?? ? x+sin(y/2+!WAVE!/10)*6 (65-y)/0.66 & line 0 1 dc 0,50,120,50 & block 0 120,0,120,80 0,0 08" f1:0,0,240,80
