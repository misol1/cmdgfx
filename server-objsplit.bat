...
set __=.
cmdgfx_input.exe m0nuW10x | call %0 %* | cmdgfx_gdi "" Sf0:0,0,360,%H%,%W%,%H%N315
set __=
...
set /a RX=0, RY=0, RZ=0, XMID=%W%/2, YMID=%H%/2, XMID2=%W%/2+%W%, DIST=2500, DRAWMODE=2, ACTIVE_KEY=0
set ASPECT=0.7083
...
set SPLITSCR=""& for /l %%a in (1,2,100) do set SPLITSCR="!SPLITSCR:~1,-1! & block 0 %W%,%%a,%W%,1 0,%%a"

set STOP=
:REP
for /L %%1 in (1,1,400) do if not defined STOP for %%o in (!DRAWMODE!) do (
	echo "cmdgfx: fbox 8 0 . & 3d objects\torus.plg !DRAWMODE!,!O%%o! !RX!,!RY!,!RZ! 0,0,0 -1,-1,-1, 0,0,0 1,-4000,0,10 !XMID!,!YMID!,!DIST!,%ASPECT% !PAL! & 3d objects\springy1.plg !DRAWMODE!,!O%%o! !RY!,!RZ!,!RZ! 0,0,0 -1,-1,-1, 0,0,0 1,-4000,0,10 !XMID2!,!YMID!,!DIST!,%ASPECT% !PAL! & %SPLITSCR:~1,-1%" F
